...
from ultralytics.nn.modules import (
    ...
    CBFuse,
    CBLinear,
    Silence, CBAM,C2f_DySnakeConv,C2f_Res2Block,LAWDS,CoordAtt
)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            DWConvTranspose2d,
            C3x,
            RepC3, C2f_DySnakeConv, CBAM, C2f_Res2Block,LAWDS,CoordAtt
        }:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3,C2f_DySnakeConv,C2f_Res2Block):
