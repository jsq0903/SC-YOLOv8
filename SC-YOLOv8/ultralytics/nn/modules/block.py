...
from .conv import Conv, DWConv, GhostConv, LightConv, RepConv, autopad, CBAM, DySnakeConv
...
__all__ = (
    ...
    "CBFuse",
    "CBLinear",
    "Silence","C2f_DySnakeConv","CBAM","C2f_Res2Block"
)
...
class C2f_Res2Block(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.cv2 = Conv((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.ModuleList(
            Bottle2neck(self.c, self.c, shortcut) for _ in range(n))  # Bottleneck
